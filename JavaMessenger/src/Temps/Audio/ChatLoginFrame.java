...
public class ChatLoginFrame extends JFrame {
    ...
    private void jbInit() throws Exception {
        ...
        jButton1.setFont(new java.awt.Font("����", Font.PLAIN, 13));
        jButton1.setText("ȷ��");
        ...
        addrTField.setFont(new java.awt.Font("����", Font.PLAIN, 13));
        ...
        jButton2.setFont(new java.awt.Font("����", Font.PLAIN, 13));
        jButton2.setText("ȡ��");
    ...
    public void jButton1_actionPerformed(ActionEvent e) { //���������ж�
        dispose();
        if(hasServer == false){
            serverPort = 2008;
        } else {
